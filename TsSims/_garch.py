...
from ._garch_core import _to_list, _normalize_coef, _make_standard_variance_fn, _run_garch_simulation
...
def simulate_garch(
    ...
    """
    alpha = _normalize_coef(alpha, 0.2, p)
    beta = _normalize_coef(beta, 0.5, q)
